...
$final_title=array("water","wetland","coniferous_forest","deciduous_short","deciduous_medium","deciduous_tall","grass_1","grass_2","cut_hay","corn","soybeans","barren__fallow","structures","roads__impervious","sum");
...
$output;
	...
	$output->water=$final_percentage[0]/$final_percentage[14]*100;  
	$output->wetland=$final_percentage[1]/$final_percentage[14]*100;  
	$output->coniferous_forest=$final_percentage[2]/$final_percentage[14]*100;  
	$output->deciduous_short=$final_percentage[3]/$final_percentage[14]*100;  
	$output->deciduous_medium=$final_percentage[4]/$final_percentage[14]*100;  
	$output->deciduous_tall=$final_percentage[5]/$final_percentage[14]*100;  
	$output->grass_1=$final_percentage[6]/$final_percentage[14]*100;  
	$output->grass_2=$final_percentage[7]/$final_percentage[14]*100;  
	$output->cut_hay=$final_percentage[8]/$final_percentage[14]*100;  
	$output->corn=$final_percentage[9]/$final_percentage[14]*100;  
	$output->soybeans=$final_percentage[10]/$final_percentage[14]*100;  
	$output->barren__fallow=$final_percentage[11]/$final_percentage[14]*100;  
	$output->structures=$final_percentage[12]/$final_percentage[14]*100;  
	$output->roads__impervious=$final_percentage[13]/$final_percentage[14]*100;  
