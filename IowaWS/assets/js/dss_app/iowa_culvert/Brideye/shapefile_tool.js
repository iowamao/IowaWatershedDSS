...
maptool.polygon.edit = function() {
    ...
    var pin_options = {
        draggable: true, 
        icon: '/ksc/templates/images/kscmap/toolpin.png', 
        height: icon_height, 
        width: icon_width, 
    ...
    splitter_options.icon =  '/ksc/templates/images/kscmap/toolbox.png';
...
maptool.init_map = function() {
    ...
    maptool.instance = new Microsoft.Maps.Map(document.getElementById("map"), {
