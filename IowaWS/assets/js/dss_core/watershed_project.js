				...
				if(project_detail.hasOwnProperty(project_org)){
					...
					if(project_detail[project_org].hasOwnProperty(project_name)){
						...
						if(typeof(result_type)!='undefined'){
							...
							if(result_type=='project_list'){
							array_project_detail_list.push(project_detail[project_org][project_name]);
							final_result = array_project_detail_list;	
							}
